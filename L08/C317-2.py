...
# реализуйте метод calculate_area, который считает половину площади круга. Желательно, чтобы это было
# сделано через переиспользование метода calculate_area родительского класса.
...
class SemiCircle(Circle):
    ...
    def calculate_area(self):
        return ( super()._pi * self._radius ** 2 / 2)
